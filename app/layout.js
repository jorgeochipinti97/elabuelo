...
export default function RootLayout({ children }) {
  return (
    <html lang="en">
      <head>
        <title>El Abuelo | Colchones y Sommiers</title>
        <link
      ...
      <body className={inter.className}>
        <Providers>
          ...
          <section
            ...
            class="lg:hidden block fixed inset-x-0 bottom-0 z-10 bg-red-950/80 shadow"
          >
            <div id="tabs" class="flex justify-between">
              <a
                href="/"
                class="w-full  focus:text-red-500 hover:text-red-500 justify-center inline-block text-center pt-2 pb-1"
              >
                <svg
                  width="25"
                  height="25"

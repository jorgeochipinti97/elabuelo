      ...
      <main className="flex-1 p-5 pt-32  bg-white  ml-64">
        <table className="w-11/12">
          ...
          <tbody>
            {orders &&
              orders.map((e) => (
                <tr key={e._id} className="border-y-2 border-black py-2">
                  <td className="">
                    <p className="text-slate-800 text-center my-5">{e._id}</p>
                  </td>
                  <td className="">
                    <p className="text-slate-800 text-center my-5">{e.shippingAddress.name}</p>
                  </td>
                  <td className="">
                  ...
                  <td >
                    <a className="text-slate-50 px-2 py-1 bg-black rounded-full  " href={`/admin/orders/${e._id}`}>
Ver
                    </a>
                  </td>
                </tr>
